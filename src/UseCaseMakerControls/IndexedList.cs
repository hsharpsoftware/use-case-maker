	...
	public class IndexedList : System.Windows.Forms.Panel
	{
		...
		public int IndexColumnWidth
		{
			...
			set
			{
                ...
                if(this.DisplayRectangle.Width - value < 50)
                {
                    return;
                }
				this.indexColumnWidth = value;
                this.textColumnWidth = this.ClientRectangle.Width - this.indexColumnWidth;
                if(this.DesignMode)
                {
                    this.Refresh();
                }
		...
		public int TextColumnWidth
		{
			...
			set
			{
                ...
                this.indexColumnWidth = this.ClientRectangle.Width - this.textColumnWidth;
                if(this.DesignMode)
                {
                    this.Refresh();
                }
