...
namespace UseCaseMakerControls
{
	...
	/// </summary>
	public class IndexedListItem : Control
	{
        ...
        public String SelectedText
        {
            get
            {
                return this._text.SelectedText;
            }
        }
		#endregion

		#region Public Methods
        public void SelectText(Int32 start, Int32 length)
        {
            this._text.Select(start, length);
            this._text.ScrollToCaret();
        }

        public void ReplaceText(String text)
        {
            this._text.SelectedText = text;
        }
		#endregion
